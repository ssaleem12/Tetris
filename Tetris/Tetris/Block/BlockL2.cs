...
namespace Tetris
{
    class BlockL2 : MainBlock
    {
        ...
        public override void Rotate(Box[,] gameGrid)
        {
            ...
            {
                if (b1.y < 3 || b1.y >28 || b1.x < 2) return;
            }
            ...
            switch (nextOrientation)
            {
                case Shape.Orientation.ORIENT_0:
                    ...
                    if (gameGrid[y2, x2] != null || gameGrid[o, x3] != null || gameGrid[o, x4] != null)
                    {
                        break;
                    }
                    else
                ...
                case Shape.Orientation.ORIENT_2:
                    ...
                    if (gameGrid[y22, x22] != null || gameGrid[o2, x32] != null || gameGrid[o2, x42] != null)
                    {
                        break;
                    }
                    else
